...
export async function createEmployer(input: any) {
    ...
    const newEmployer = await prisma.$transaction(async (tx) => {
        const data: any = {
            ...
            fullAddress: coreData.fullAddress || coreData.address,
            fullAddressEn: coreData.addressEn,
        ...
        if (corporateInfo || coreData.factoryRegistrationNo) {
            ...
            data.corporateInfo = {
                create: {
                    ...
                    factoryCity: corpData.factoryCity,
                    factoryDistrict: corpData.factoryDistrict,
                    factoryAddressDetail: corpData.factoryAddressDetail || corpData.factoryAddress,
                    factoryZipCode: corpData.factoryZipCode,
        ...
        if (individualInfo || coreData.responsiblePersonIdNo) {
            ...
            data.individualInfo = {
                create: {
                    ...
                    careCity: indData.careCity,
                    careDistrict: indData.careDistrict,
                    careAddressDetail: indData.careAddressDetail || indData.careAddress,
                    careZipCode: indData.careZipCode,
...
export async function updateEmployer(id: string, data: any) {
    ...
    if (indSource) {
        const indUpdateData = {
            ...
            careCity: indSource.careCity,
            careDistrict: indSource.careDistrict,
            careAddressDetail: indSource.careAddressDetail || indSource.careAddress,
            careZipCode: indSource.careZipCode,
        ...
        for (const factory of existingFactoriesUpdateList) {
            await tx.employerFactory.update({
                ...
                data: {
                    ...
                    factoryCity: factory.city || factory.factoryCity,
                    factoryDistrict: factory.district || factory.factoryDistrict,
                    factoryAddressDetail: factory.addressDetail || factory.address || factory.factoryAddress || factory.factoryAddressDetail,
                    factoryZipCode: factory.zipCode || factory.factoryZipCode,
                    factoryFullAddressEn: factory.addressEn,
