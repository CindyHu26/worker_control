    ...
    return (
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 max-w-4xl mx-auto">
            <Card className="border-slate-200 shadow-sm">
                ...
                <CardContent className="p-6 pt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Basic Info */}
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            disabled={loading} // Often code is editable, so keep enabled
                        />
                    ...
                    <div className="space-y-2 md:col-span-2">
                        <Label htmlFor="address" className="text-slate-700 font-medium">地址 (Address)</Label>
                        <Input
                            id="address"
                            {...form.register('address')}
                            className="bg-white border-slate-300"
                            placeholder="完整地址 Including Zip Code"
                            disabled={loading}
                        />
                    </div>
                    ...
                    <div className="space-y-2 md:col-span-2">
                        ...
                        {/* Assuming Textarea wrapper exists, otherwise use standard textarea or Input */}
                        <textarea
                            id="notes"
                            {...form.register('notes')}
