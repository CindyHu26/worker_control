 ...
 * Last synced: 2025-12-22 09:27:01
 */
/**
...
export const CreateEmployerInputSchema = z.object({
    ...
    initialRecruitmentLetters: z.array(z.object({
        letterNumber: z.string().min(1, '?賣???憛?),
        issueDate: z.coerce.date(),
        expiryDate: z.coerce.date(),
        approvedQuota: z.coerce.number().int().min(1, '?詨???敹?憭扳0')
    })).optional()
});
...
export const CreateDeploymentInputSchema = z.object({
    ...
    startDate: z.string().datetime().or(z.coerce.date(), { message: 'Invalid start date' }),
...
/**
 * Re-export all types for easy frontend consumption
 * Frontend can import: import type { EmployerResponse, CreateEmployerInput } from '@/lib/types/api'
 */
export type {
    PaginationParams,
    PaginationMeta,
