        ...
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-500">?®ÈÉ®ÂæÖË???/p>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-red-600">?î¥ Á∑äÊÄ?/p>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-yellow-600">?ü° Ë≠¶Â?</p>
                ...
                >
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-blue-600">?îµ Ë≥áË?</p>
            ...
            {loading ? (
                ...
                <div className="text-center py-20 text-gray-500">
                    ...
                    <p className="text-lg">?ÆÂ?Ê≤íÊ??∞Â∏∏Ë≠¶Á§∫</p>
                    <p className="text-sm">ÈªûÊ??åÈ??∞Ê??è„Äç‰?Ê™¢Êü•Á≥ªÁµ±?∞Â∏∏</p>
                </div>
            ) : (
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                {criticalAlerts.length === 0 && (
                                    <p className="text-center py-8 text-gray-400 text-sm">?°Á??•Ë≠¶Á§?/p>
                                )}
                            </div>
                        </div>
                    )}
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                {warningAlerts.length === 0 && (
                                    <p className="text-center py-8 text-gray-400 text-sm">?°Ë≠¶?ä‰???/p>
                                )}
                            </div>
                        </div>
                    )}
                    ...
                    {(filter === 'ALL' || filter === 'INFO') && (
                        <div>
                            ...
                            <div className="space-y-3">
                                ...
                                {infoAlerts.length === 0 && (
                                    <p className="text-center py-8 text-gray-400 text-sm">?°Â?Ëæ¶Ë?Ë®?/p>
                                )}
                            </div>
                        </div>
                    )}
