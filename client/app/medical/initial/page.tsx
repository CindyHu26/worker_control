        ...
        <div className="min-h-screen bg-slate-50">
            <div className="bg-white border-b border-slate-200 px-6 py-4">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-2 text-sm text-slate-600 mb-2">
                        ...
                        <span>/</span>
                        <span className="text-slate-900 font-medium">初次體檢</span>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900">初次體檢管理</h1>
                                    <p className="text-sm text-slate-500">Initial Medical Checkup</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 text-center">
                    ...
                    <h2 className="text-xl font-bold text-slate-800 mb-2">入國後3日內體檢</h2>
                    <p className="text-slate-600 mb-6">管理新進移工之入境健康檢查安排</p>
