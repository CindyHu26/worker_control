            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-2 text-sm text-slate-600 mb-2">
                        ...
                        <span>/</span>
                        <span className="text-slate-900 font-medium">服務團隊</span>
                    </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-slate-100 rounded-lg">
                                    <Users2 className="text-slate-600" size={24} />
                                </div>
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900">服務團隊管理</h1>
                                    <p className="text-sm text-slate-500">Service Team Assignments</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 text-center">
                    <div className="w-16 h-16 bg-slate-100 rounded-full flex items-center justify-center mx-auto mb-4">
                        <Users2 className="text-slate-600" size={32} />
                    </div>
                    <h2 className="text-xl font-bold text-slate-800 mb-2">業務與雙語人員指派</h2>
                    <p className="text-slate-600 mb-6">管理各雇主與宿舍之專責服務人員配置</p>
