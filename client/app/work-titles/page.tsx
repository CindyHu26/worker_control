        ...
        >
            ...
            <TableWrapper>
                <Table>
                    <TableHeader>
                        <TableRow>
                            <TableHead>工種代碼</TableHead>
                            <TableHead>中名稱</TableHead>
                            <TableHead>歸屬申請類別</TableHead>
                            <TableHead>標籤</TableHead>
                            <TableHead className="text-right">一就安費</TableHead>
                            <TableHead className="text-right">許可就業中</TableHead>
