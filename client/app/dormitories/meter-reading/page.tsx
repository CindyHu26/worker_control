        ...
        <div className="min-h-screen bg-slate-50">
            <div className="bg-white border-b border-slate-200 px-6 py-4">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-2 text-sm text-slate-600 mb-2">
                        ...
                        <span>/</span>
                        <span className="text-slate-900 font-medium">水電抄表</span>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900">水電抄表作業</h1>
                                    <p className="text-sm text-slate-500">Utility Meter Reading</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 text-center">
                    ...
                    <h2 className="text-xl font-bold text-slate-800 mb-2">每月度數抄錄</h2>
                    <p className="text-slate-600 mb-6">紀錄各宿舍房間之水電表度數以利費用分攤</p>
