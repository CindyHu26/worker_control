...
export default function ServiceFeesPage() {
    ...
    return (
        <PageContainer title="每月服務費管理 (Service Fees)" showBack onBack={() => window.location.href = '/portal'}>
            ...
            <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm mb-6 flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-medium text-slate-700">帳務月份:</span>
                        <input
                            type="month"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm">
                    <div className="text-sm text-slate-500 mb-1">本月應收總額</div>
            ...
            <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
                {loading ? (
                    ...
                    <div className="text-center py-12 text-slate-500">本月尚無服務費帳單</div>
                ) : (
                    <table className="w-full text-left">
                        <thead className="bg-slate-50 border-b border-slate-200">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-sm font-medium text-slate-500">金額</th>
