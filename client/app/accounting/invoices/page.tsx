        ...
        <div className="min-h-screen bg-slate-50">
            <div className="bg-white border-b border-slate-200 px-6 py-4">
                <div className="max-w-7xl mx-auto">
                    <div className="flex items-center gap-2 text-sm text-slate-600 mb-2">
                        ...
                        <span>/</span>
                        <span className="text-slate-900 font-medium">帳單管理</span>
                    </div>
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h1 className="text-2xl font-bold text-slate-900">帳單與應收管理</h1>
                                    <p className="text-sm text-slate-500">Invoices & Accounts Receivable</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-8 text-center">
                    ...
                    <h2 className="text-xl font-bold text-slate-800 mb-2">應收帳款作業</h2>
                    <p className="text-slate-600 mb-6">管理所有對雇主與移工之應收帳單與入帳紀錄</p>
